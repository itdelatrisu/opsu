...
public class Music {
	...
	public void loop(){System.out.println("Music loop "+music.getName());music.loop();
		lastPosition = music.getPosition();
		lastTime = TimeUtils.millis();
	}

	public void play(){System.out.println("Music play "+music.getName());music.play();	
		lastPosition = music.getPosition();
		lastTime = TimeUtils.millis();
	}
	...
	public void pause(){System.out.println("Music pause "+music.getName());music.pause();}

	public void resume(){System.out.println("Music resume "+music.getName());music.resume();}

	public void setVolume(float volume){}

	public void stop(){System.out.println("Music stop "+music.getName());music.stop();}

	public void fade(int duration, float f, boolean b){System.out.println("Music fade "+music.getName());music.fade(duration, f, b);}
	...
	public void dispose(){System.out.println("Music pause "+music.getName());music.dispose();}
