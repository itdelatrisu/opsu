...
public class BackButton {
	...
	/** The container associated with the UI element */
	private final GameContainer container;

	/** Button text. */
	private String buttonText = "back";
	...
	public void draw(Graphics g) {
		...
		Fonts.MEDIUM.drawString(textX, textY + 1, buttonText, Color.black);
		Fonts.MEDIUM.drawString(textX, textY, buttonText, Color.white);
	}
