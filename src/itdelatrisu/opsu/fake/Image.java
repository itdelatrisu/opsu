...
public class Image {
	...
	public void draw() {
		Graphics.setColor(Color.white.multAlpha(alpha));
		//Graphics.setColor(Color.white);
		
		Graphics.drawTexture(getTextureRegion(), 0, 0, getWidth(),getHeight(),rotation);
	}
	public void draw(float x, float y) {
		...
		Graphics.drawTexture(getTextureRegion(),x,y, getWidth(),getHeight(),rotation);
	}

	public void draw(float x, float y, Color filter) {
		Graphics.setColor(filter.multAlpha(alpha));
		//Graphics.setColor(Color.white);
		Graphics.drawTexture(getTextureRegion(), x, y, getWidth(),getHeight(),rotation);
	}
	public void drawCentered(float x, float y) {
		Graphics.setColor(Color.white.multAlpha(alpha));
		//Graphics.setColor(Color.white);
		Graphics.drawTexture(getTextureRegion(), x-getWidth()/2, y-getHeight()/2,getWidth(),getHeight(),rotation);
	}
