...
public class Graphics {
	...
	public static void drawString(UnicodeFont font, String str, float x, float y) {
		checkMode(SPRITE);
		font.bitmap.setColor(fgcolor.r, fgcolor.g, fgcolor.b, fgcolor.a);
		font.bitmap.draw(batch, str, x, height-y-font.getHeight(str));
		
	}

	

	public static void setColor(Color ncolor) {
		fgcolor = ncolor;
		batch.setColor(clamp(ncolor.r,0,1), clamp(ncolor.g,0,1), clamp(ncolor.b,0,1), clamp(ncolor.a,0,1));
		shapeRender.setColor(clamp(ncolor.r,0,1), clamp(ncolor.g,0,1), clamp(ncolor.b,0,1), clamp(ncolor.a,0,1));
	}
	...
	public void fillArc(float x, float y, float w,
	...
	public static void drawTexture(TextureRegion tex, float x, float y,float wid,float hei, float rotation) {
		checkMode(SPRITE);
		if(tex == null)
