	...
	public void createDownload(DownloadServer server) {
		...
		download.setListener(new DownloadListener() {
			...
			public void completed() {
				UI.getNotificationManager().sendNotification("ui.notifications.download.complete", Colors.GREEN, getTitle());
			}

			@Override
			public void error() {
				UI.getNotificationManager().sendNotification("ui.notifications.download.failed", Color.red);
			}
		});
